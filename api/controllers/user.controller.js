...
export const updateUser = async (req, res, next) => {
    ...
    if(req.body.username){
        ...
        if(req.body.username !== req.body.username.lowercase()){
            req.body.username = req.body.username.lowercase()
        }
        try {
            const updatedUser = await User.findByIdUpdate(req.params.UserId, {
                $set: {
